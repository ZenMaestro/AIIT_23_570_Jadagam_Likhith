...
<p align="center">
  <img src="https://img.shields.io/badge/Experiment-15-blue?style=for-the-badge"/>
  <img src="https://img.shields.io/badge/GitHub-Version%20Control-black?style=for-the-badge&logo=github"/>
  <img src="https://img.shields.io/badge/Status-Completed-success?style=for-the-badge"/>
  <img src="https://img.shields.io/badge/Focus-Collaboration-orange?style=for-the-badge"/>
</p>
...
```mermaid
flowchart TD
    A(Start) --> B(Login to GitHub)
    B --> C(Create Repository)
    C --> D(Clone to Local Machine)
    D --> E(Add/Edit Files)
    E --> F(git add)
    F --> G(git commit)
    G --> H(git push)
    H --> I(View on GitHub)
    I --> J(Optional git pull)
    J --> K(End)
```
...
```md
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:0f2027,100:2c5364&height=200&section=header&text=GitHub%20Experiment&fontSize=35&fontColor=ffffff"/>
</p>
```
